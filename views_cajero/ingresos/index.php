...
?>
    ...
    <body>
        ...
        <div class="container-dashboard h-screen">
            ...
            <div id="crear-ingreso" class="modal-create md-hidden">
                <div class="form-create">
                    <!-- <form id="form_producto_add"> -->
                    <div class="close-modal">
                        <ion-icon name="close-outline"></ion-icon>
                    </div>
                    <h1 class="font-bold">Nuevo Ingreso</h1>
                    <div>
                        <div class="grid grid-cols-1 gap-3">
                            <div class="group flex flex-col">
                                <label class="text-sm font-bold" for="tipogasto">Tipo de ingreso</label>
                                <select style="width: 100%; background: #ececec" id="tipo_ingreso" class="text-sm w-full px-3 py-2 rounded bg-gray-200" name="state">
                                    <option disabled value="0">Seleccione el tipo de ingreso</option>
                            ...
                            <div class="group">
                                ...
                                <input placeholder="Escribe aqui el detalle de venta" type="text" id="descripcion_ingreso" class="text-sm w-full px-3 py-2 rounded bg-gray-100">
                            </div>
                            <div class="group">
                                <label class="text-sm font-bold" for="cliente">Monto</label>
                                <input placeholder="Escribe aqui monto" type="number" step="0.01" id="monto_ingreso" class="text-sm w-full px-3 py-2 rounded bg-gray-100">
                            </div>

                        </div>

                        <button type="submit" id="registrar_ingreso_btn" class="text-white bg-[#310ecd] px-3 py-2 rounded text-sm mt-6">Registrar</button>
                    </div>
            ...
            <div class="flex w-full">
                <button id="new-ingreso" class="px-3 py-2 text-white bg-[#310ecd] rounded">+ Nuevo Ingreso</button>
            </div>
            <div class="datatable-main mt-4 bg-white px-4 py-3 rounded shadow">
                <table id="ingresosList" class="table cust-datatable dataTable no-footer" style="width:100%;">
                    <thead>
                        <tr>
    ...
    <script src="../../js/dinamic/gestion_ingresos.js"></script>
