...
?>
                    ...
                    <div>
                        <div class="grid grid-cols-1 gap-3">
                            <div class="group flex flex-col">
                                <label class="text-sm font-bold" for="sedeList">Sede</label>
                                <select style="width: 100%; background: #ececec" id="sedeList" class="text-sm w-full px-3 py-2 rounded bg-gray-200" name="state">
    ...
    <script src="../../js/dinamic/gestion_gastos_admin.js"></script>
